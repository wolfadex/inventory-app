...
**Dev Notes**
- The codegen for `Acadia.Serialize` currently only supports Acadia endpoints with 1 argument (excluding `Cookies`). Additionally, it doesn't yet support anonymous records. E.g.
```elm
