// elm-watch hot {"version":"2.0.0-beta.7","targetName":"My app","webSocketConnection":63559,"webSocketToken":"84f808d8-48e4-406b-bf2a-5e4cb1945a55"}
"use strict";
(() => {
...
${indent.repeat(level)}}`;
  ...
  var WEBSOCKET_TOKEN = "84f808d8-48e4-406b-bf2a-5e4cb1945a55";
  ...
  var WEBSOCKET_CONNECTION = "63559";
...
var $author$project$Main$Unauthenticated = {$: 'Unauthenticated'};
...
var $author$project$Route$fromUrl = function (url) {
	var _v0 = $lydell$elm_app_url$AppUrl$fromUrl(url).path;
	if (!_v0.b) {
		return $elm$core$Maybe$Just($author$project$Route$Home);
	} else {
		if ((_v0.a === 'login') && (!_v0.b.b)) {
			return $elm$core$Maybe$Just($author$project$Route$Login);
		} else {
			return $elm$core$Maybe$Nothing;
		}
	}
...
var $author$project$Page$HomeMsg = function (a) {
	return {$: 'HomeMsg', a: a};
};
var $author$project$Page$Login = function (a) {
	return {$: 'Login', a: a};
};
var $author$project$Page$LoginMsg = function (a) {
	return {$: 'LoginMsg', a: a};
};
...
var $author$project$Page$Login$Fresh = {$: 'Fresh'};
var $author$project$Page$Login$Unauthenticated = function (a) {
	return {$: 'Unauthenticated', a: a};
};
var $author$project$Page$Login$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Page$Login$Unauthenticated(
			{email: '', password: '', user: $author$project$Page$Login$Fresh}),
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Main$initPage = function (route) {
	if (route.$ === 'Login') {
		return A3(
			$elm$core$Tuple$mapBoth,
			$author$project$Page$Login,
			$elm$core$Platform$Cmd$map(
				A2($elm$core$Basics$composeR, $author$project$Page$LoginMsg, $author$project$Main$PageMsg)),
			$author$project$Page$Login$init(_Utils_Tuple0));
	} else {
		return A3(
			$elm$core$Tuple$mapBoth,
			$author$project$Page$Home,
			$elm$core$Platform$Cmd$map(
				A2($elm$core$Basics$composeR, $author$project$Page$HomeMsg, $author$project$Main$PageMsg)),
...
var $author$project$Main$init = F3(
	function (_v0, url, navKey) {
		...
		var _v1 = $author$project$Main$initPage(initialRoute);
		var page = _v1.a;
		var cmd = _v1.b;
		return _Utils_Tuple2(
			{authentication: $author$project$Main$Unauthenticated, navKey: navKey, page: page},
			cmd);
	});
...
var $author$project$Page$Home$update = function (config) {
...
var $author$project$Page$Login$CreatingOrganization = function (a) {
	return {$: 'CreatingOrganization', a: a};
};
var $author$project$Page$Login$LoadingUser = {$: 'LoadingUser'};
var $author$project$Page$Login$Processing = {$: 'Processing'};
var $author$project$Page$Login$UserAuthenticated = function (a) {
	return {$: 'UserAuthenticated', a: a};
};
...
var $elm$http$Http$expectBytes = F2(
...
var $author$project$Acadia$Transaction$attempt = F3(
	function (url, toMsg, _v0) {
		var encoder = _v0.a;
		var decoder = _v0.b;
		return $elm$http$Http$post(
			{
				body: A2(
					...
					$elm$bytes$Bytes$Encode$encode(encoder)),
				expect: A2(
					$elm$http$Http$expectBytes,
					A2($elm$core$Basics$composeL, toMsg, $elm$core$Result$toMaybe),
					decoder),
				url: url
			});
	});
...
var $author$project$Backend$authenticate = function (v0) {
	return A2(
...
var $author$project$Page$Login$update = function (config) {
	var model = config.model;
	switch (model.$) {
		case 'Unauthenticated':
			var unauthenticatedModel = model.a;
			var _v1 = config.msg;
			switch (_v1.$) {
						...
						config.toModel(
							$author$project$Page$Login$Unauthenticated(
								_Utils_update(
									...
									{password: password}))),
						$elm$core$Platform$Cmd$none);
				case 'UserSubmittedAuthForm':
					return _Utils_Tuple2(
						config.toModel(
							$author$project$Page$Login$Unauthenticated(
								_Utils_update(
									unauthenticatedModel,
									{user: $author$project$Page$Login$Processing}))),
						A3(
							$author$project$Acadia$Transaction$attempt,
							'/_endpoints',
							A2($elm$core$Basics$composeR, $author$project$Page$Login$UserAuthenticated, config.toMsg),
							$author$project$Backend$authenticate(
								{email: unauthenticatedModel.email, password: unauthenticatedModel.password})));
				case 'UserAuthenticated':
					if (_v1.a.$ === 'Nothing') {
						...
						return _Utils_Tuple2(
							config.toModel($author$project$Page$Login$LoadingUser),
							$elm$core$Platform$Cmd$none);
					}
				default:
					return _Utils_Tuple2(
		...
		default:
			var createOrganizationModel = model.a;
			var _v3 = config.msg;
			switch (_v3.$) {
				case 'UserChangedOrganizationName':
					var name = _v3.a;
					return _Utils_Tuple2(
						config.toModel(
							$author$project$Page$Login$CreatingOrganization(
								_Utils_update(
									createOrganizationModel,
									{name: name}))),
						$elm$core$Platform$Cmd$none);
				case 'UserSubmittedOrganizationCreateForm':
					return _Utils_Tuple2(
						config.toModel(
							$author$project$Page$Login$CreatingOrganization(
								_Utils_update(
									createOrganizationModel,
									{organization: $author$project$Page$Login$Processing}))),
						$elm$core$Platform$Cmd$none);
				default:
					return _Utils_Tuple2(
						config.toModel(model),
...
var $author$project$Main$updatePage = F2(
	function (pageMsg, model) {
		if (pageMsg.$ === 'LoginMsg') {
							...
							function (user, _v2) {
								...
								return _Utils_Tuple2(
									_Utils_update(
										m,
										{
											authentication: $author$project$Main$Authenticated(user)
										}),
									cmd);
							}),
						model: loginModel,
						msg: loginMsg,
						toModel: function (pageModel) {
							return _Utils_update(
								model,
								{
									page: $author$project$Page$Login(pageModel)
								});
						},
						toMsg: A2($elm$core$Basics$composeR, $author$project$Page$LoginMsg, $author$project$Main$PageMsg)
					});
			} else {
			...
			if (_v3.$ === 'Home') {
				var homeModel = _v3.a;
				return $author$project$Page$Home$update(
					{
						model: homeModel,
						msg: homeMsg,
						toModel: function (pageModel) {
						...
						toMsg: A2($elm$core$Basics$composeR, $author$project$Page$HomeMsg, $author$project$Main$PageMsg)
					});
			} else {
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			}
		...
		switch (msg.$) {
			...
			case 'UrlChanged':
				...
				var initialRoute = A2(
					...
					$author$project$Route$Login,
					$author$project$Route$fromUrl(url));
				var _v2 = $author$project$Main$initPage(initialRoute);
				var page = _v2.a;
				var cmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Inventory App')
						]))
				]));
	});
...
var $author$project$Page$Login$viewAuthenticating = A2(
	$elm$html$Html$h2,
	_List_Nil,
	_List_fromArray(
		[
			$elm$html$Html$text('Logging in ...')
		]));
var $author$project$Page$Login$UserChangedOrganizationName = function (a) {
	return {$: 'UserChangedOrganizationName', a: a};
};
var $author$project$Page$Login$UserSubmittedOrganizationCreateForm = {$: 'UserSubmittedOrganizationCreateForm'};
...
var $author$project$Page$Login$viewCreateOrganization = function (model) {
	return A2(
		$elm$html$Html$form,
		_List_fromArray(
			[
				$elm$html$Html$Events$onSubmit($author$project$Page$Login$UserSubmittedOrganizationCreateForm),
				A2($elm$html$Html$Attributes$style, 'display', 'grid'),
				A2($elm$html$Html$Attributes$style, 'grid-template-columns', '5rem 10rem'),
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onInput($author$project$Page$Login$UserChangedOrganizationName),
						$elm$html$Html$Attributes$disabled(
						_Utils_eq(model.organization, $author$project$Page$Login$Processing))
					]),
				_List_Nil),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Create Organization')
					]))
			]));
};
var $author$project$Page$Login$UserChangedEmail = function (a) {
	return {$: 'UserChangedEmail', a: a};
};
var $author$project$Page$Login$UserChangedPassword = function (a) {
	return {$: 'UserChangedPassword', a: a};
};
var $author$project$Page$Login$UserSubmittedAuthForm = {$: 'UserSubmittedAuthForm'};
var $elm$html$Html$span = _VirtualDom_node('span');
var $author$project$Page$Login$viewUnauthenticated = function (model) {
	return A2(
		$elm$html$Html$form,
		_List_fromArray(
			[
				$elm$html$Html$Events$onSubmit($author$project$Page$Login$UserSubmittedAuthForm),
				A2($elm$html$Html$Attributes$style, 'display', 'grid'),
				A2($elm$html$Html$Attributes$style, 'grid-template-columns', '5rem 10rem'),
				A2($elm$html$Html$Attributes$style, 'gap', '1rem'),
				A2($elm$html$Html$Attributes$style, 'border', '1px solid black'),
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onInput($author$project$Page$Login$UserChangedEmail),
						$elm$html$Html$Attributes$disabled(
						_Utils_eq(model.user, $author$project$Page$Login$Processing))
					]),
				_List_Nil),
				A2(
				$elm$html$Html$label,
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onInput($author$project$Page$Login$UserChangedPassword),
						$elm$html$Html$Attributes$disabled(
						_Utils_eq(model.user, $author$project$Page$Login$Processing))
					]),
				_List_Nil),
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Login / Sign Up')
					])),
				function () {
				var _v0 = model.user;
				if (_v0.$ === 'Failure') {
		...
		_List_fromArray(
			[
				...
				switch (model.$) {
					case 'Unauthenticated':
						var unauthenticatedModel = model.a;
						return $author$project$Page$Login$viewUnauthenticated(unauthenticatedModel);
					case 'LoadingUser':
						return $author$project$Page$Login$viewAuthenticating;
					default:
						var createOrganizationModel = model.a;
						return $author$project$Page$Login$viewCreateOrganization(createOrganizationModel);
				}
			}()
			]));
};
...
var $author$project$Main$viewUnauthenticated = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
		...
		body: _List_fromArray(
			[
				...
				if (_v0.$ === 'Login') {
					...
					var pageModel = _v0.a;
					var _v1 = model.authentication;
					if (_v1.$ === 'Authenticated') {
						var user = _v1.a;
						return A2(
							$elm$html$Html$map,
							A2($elm$core$Basics$composeR, $author$project$Page$HomeMsg, $author$project$Main$PageMsg),
							A2($author$project$Page$Home$view, user, pageModel));
					} else {
						return $author$project$Main$viewUnauthenticated;
					}
				}
			}()
			]),
